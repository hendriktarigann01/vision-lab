        ...
        <div className="text-center">
          ...
          <div className="mb-8 md:flex gap-2 space-y-5">
            <p className="text-gray-600 text-lg">
              <span className="text-4xl text-orange-500">Oops,</span> Page Not
              Found. Please go back to the Home Page.
            </p>
            <Button
              className="bg-orange-500 hover:bg-orange-600 w-36 font-normal text-white cursor-pointer px-12 py-6 rounded-full text-lg"
