        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center w-full">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-wrap justify-center md:justify-start pt-4">
              <button className="flex items-center justify-center h-auto md:h-14 gap-2 w-36 md:w-48 cursor-pointer md:px-8 py-3 bg-brand-200 hover:bg-brand-300 text-white rounded-full">
